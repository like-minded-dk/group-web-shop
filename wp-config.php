...
$debian_main_file = CONFIG_PATH . 'config-'.strtolower($debian_main_server).'.php';
...
} elseif (file_exists(CONFIG_PATH . "config-default.php")) {
    require_once(CONFIG_PATH . "config-default.php");
    define('DEBIAN_FILE', CONFIG_PATH . "config-default.php");
} else {
