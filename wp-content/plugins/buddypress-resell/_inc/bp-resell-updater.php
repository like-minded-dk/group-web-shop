...
class BP_Resell_Updater {
	...
	protected function init() {
		...
		// May 5, 2014    - added 'resell_type' DB column
	...
	/**
	 * Installs the BP Resell DB table.
	 */
	protected function install() {
		...
		$sql[] = "CREATE TABLE {$table_prefix}bp_resell (
				id bigint(20) NOT NULL AUTO_INCREMENT PRIMARY KEY,
				leader_id bigint(20) NOT NULL,
				reseller_id bigint(20) NOT NULL,
				resell_type varchar(75) NOT NULL,
				date_recorded datetime NOT NULL default '0000-00-00 00:00:00',
			        KEY resellers (leader_id,reseller_id),
			        KEY resell_type (resell_type),
	...
	/**
	 * Returns the current revision date as set in {@link BP_Resell_Component}.
	 *
	...
	public static function get_current_revision_date() {
		...
		return $bp->resell->revision_date;
	}

	/**
	 * Returns the revision date for the BP Resell install as saved in the DB.
	 *
	...
	public static function get_installed_revision_date() {
		return strtotime( bp_get_option( '_bp_resell_revision_date' ) );
	}
	...
	protected static function bump_revision_date() {
		...
		bp_update_option( '_bp_resell_revision_date', self::get_current_revision_date() );
	}

	/** UTILITY *******************************************************/

	/**
	 * See if BP Resell is loaded.
	 *
	 * @return bool
	 */
