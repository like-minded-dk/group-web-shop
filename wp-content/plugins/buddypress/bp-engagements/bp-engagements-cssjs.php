<?php
/**
 * BP engagements component CSS/JS.
 *
 * @package BuddyPress
 * @subpackage engagementsScripts
 * @since 9.0.0
 */
...
/**
 * Registers the script to manage the dynamic part of the engagements widget/block.
 *
 * @since 9.0.0
 ...
 */
function bp_engagements_register_scripts( $scripts = array() ) {
	...
	$scripts['bp-engagements-script'] = array(
...
add_filter( 'bp_core_register_common_scripts', 'bp_engagements_register_scripts', 9, 1 );
