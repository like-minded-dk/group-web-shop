...
class BP_Nouveau_Friends {
	...
	public function register_ajax_actions() {
		$ajax_actions = array('friends_remove_engagements_from_friends', 'friends_not_engagements_from_friends','friends_remove_friend', 'friends_add_friend', 'friends_withdraw_friendship', 'friends_accept_friendship', 'friends_reject_friendship' );
