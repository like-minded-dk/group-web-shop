...
function init_product(string $product_name, float $regular_price, float $sale_price): WC_Product_Simple {
...
function handle_shortcode_create_product() {
    ...
    if (isset($_POST['product_name'], $_POST['sale_price'], $_POST['regular_price'])) {    
        ...
        $product = init_product($product_name, $regular_price, $sale_price);
