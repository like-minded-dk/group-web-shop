...
<div class="wp-block-column is-vertically-aligned-top" style="flex-basis:33.33%"><!-- wp:template-part {"slug":"sidebar","theme":"wc-shop","area":"uncategorized"} /--></div>
<!-- /wp:column -->
