...
<h2 class="wp-block-heading has-text-align-center" style="margin-top:0;margin-bottom:0;font-size:48px;line-height:1.2"><?php echo esc_html__( 'Men\'s Winter Collection', 'wc-shop' ); ?></h2>
<!-- /wp:heading -->
